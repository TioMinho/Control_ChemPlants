...
\begin{varblock}[\textwidth]{State-Feedback with Integral Action}
  Consider a State-space system and augmented state ${\color{signal1} \bm{x}}_a : \mathbb{R} \rightarrow \mathbb{R}^{p}$ defined by:
    \begin{equation*}
        {\color{signal1} \bm{x}_a(t)} = \int_{0}^{t} {\color{signal1} \bm{r}}(\tau) - {\color{signal1} \bm{y}}(\tau) d\tau \Longrightarrow {\color{signal1} \dot{{\color{signal1} \bm{x}}}_a(t)} = {\color{signal1} {\color{signal1} \bm{r}}(t)} - {\color{signal1} {\color{signal1} \bm{y}}(t)}
    .\end{equation*}
